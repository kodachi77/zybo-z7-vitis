if {[catch {
  ...
  # set project_name to be name of the XSA
  ...
  puts "INFO: Starting bitstream generation..."

  # open block design
  open_project ${project_name}.xpr
  open_bd_design ${project_name}.srcs/sources_1/bd/${design_name}/${design_name}.bd

  generate_target all [get_files ${project_name}.srcs/sources_1/bd/${design_name}/${design_name}.bd]
  validate_bd_design
  save_bd_design
  ...
  close $fd
    ...
    puts "FATAL: An error occurred during hardware platform generation"
    puts "Result: $result"
